/*
   1. DATE 형식의 날짜/시간 연산
      ...
      2) 단위 처리
         ...
         (4) 1/24/60/60 : 1초
*/
SELECT TO_CHAR(SYSDATE,               'YY/MM/DD HH24:MI:SS')  --현재 날짜와시간
     , TO_CHAR(SYSDATE + 1,          'YY/MM/DD HH24:MI:SS')   -- 다음날
     , TO_CHAR(SYSDATE - 1,          'YY/MM/DD HH24:MI:SS')   -- 전날
     , TO_CHAR(SYSDATE + 1/24,       'YY/MM/DD HH24:MI:SS')   -- 한시간 후
     , TO_CHAR(SYSDATE + 1/24/60,    'YY/MM/DD HH24:MI:SS')
     , TO_CHAR(SYSDATE + 1/24/60/60, 'YY/MM/DD HH24:MI:SS')  --1초후
  FROM DUAL;
